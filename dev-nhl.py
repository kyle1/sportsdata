...
end_date = datetime.strptime('11/11/2019', '%m/%d/%Y')
...
while loop_date <= end_date:
    ...
    game_boxscores = GameBoxscores(date_str, date_str)
    ...
    game_boxscores_path = f'csv/nhl/2019/game_boxscores/{filename_date}_game_boxscores.csv'
    ...
    player_boxscores_path = f'csv/nhl/2019/player_boxscores/{filename_date}_player_boxscores.csv'
    ...
    pbps_path = f'csv/nhl/2019/play_by_plays/{filename_date}_pbp.csv'
