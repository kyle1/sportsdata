...
class Boxscores:
        ...
        for row in rows:
            ...
            if len(td_list) > 1:
                player_passing = {
                    ...
                    'IsAway': is_away,
                    'TeamResult': self._get_team_result(is_away, game_info['away_score'], game_info['home_score']),
    ...
    def _parse_stat_tables(self, game_info, stat_tables, is_away):
    ...
    def _get_boxscores_by_game_ids(self, game_ids):
        ...
        for game_id in game_ids:
            ...
            away_stats = self._parse_stat_tables(game_info, away_tables, True)
        ...
        for box in all_boxscores:
            boxscore = Boxscore(box, scoring_plays)
